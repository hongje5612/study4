 ...
 * 구매를 했다면 각 면에 배열의 인덱스를 적어 놓고 그 순수데로 적어 주시면 됩니다.
 * 저도 인덱스를 다 적어 놓았는데도 헷갈려서, 여러번 수정을 했습니다.
 *
 * 인덱스를 적는 방법은 윗면 만 문제에서 제시 하는 방향으로 정확하게 적어 주시고,
 * 나먼지는 문제를 푸는 사람 마음대로 하시면 됩니다.
 */
